...
We provide an API containing data used for our platform. This API allows other developers and researchers to integrate and interact with the same data used to power NUS Digital Twin. [Learn how to use the API](/api).
