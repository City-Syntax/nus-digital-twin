...
You can search for a building directly using the search bar. If your menu is on the bottom, select the <span style={{ display: 'inline-block' }}><Icons.Search height="1.125rem" width="1.125rem" /></span> button to open the search bar.
