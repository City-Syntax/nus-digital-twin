...
NUS Digital Twin uses the [Route Data](https://starlight.astro.build/guides/route-data/) functionality provided by Astro Starlight to override the default behaviour of the sidebar and pagination. The route data is found in `/src/routeData.ts`.
