...
The `buildings.json` file contains an array of objects. The complete schema for building data can be found in [Building Data Reference](../buildings-reference).
