...
Specifies the data source or provider responsible for the building data. This string will be displayed to users whenever the building data panel is opened in the 'General' tab.
...
Provides information about the building models available for download. Each object within the array represents a specific type of model, and will be displayed as a button in the 'General' tab.
...
The floor to floor height of the building, specified in metres. You can specify both a single value for the whole building, or multiple values using an array of objects. This information is displayed when the building data panel is open in the 'Structural, Enclosure and Internal Partitions' tab.
...
The perimeter zone depth of the building, specified in metres. This information is displayed when the building data panel is open in the 'Structural, Enclosure and Internal Partitions' tab.
...
The wall construction of the building, specified in terms of U-value, measured in Watts per square meter per Kelvin (W/m<sup>2</sup>K). This information is displayed when the building data panel is open in the 'Structural, Enclosure and Internal Partitions' tab.
...
The roof construction of the building, specified in terms of U-value, measured in Watts per square meter per Kelvin (W/m<sup>2</sup>K). This information is displayed when the building data panel is open in the 'Structural, Enclosure and Internal Partitions' tab.
